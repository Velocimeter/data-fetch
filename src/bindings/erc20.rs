...
pub mod erc20 {
            ...
            constructor: ::core::option::Option::Some(::ethers::core::abi::ethabi::Constructor {
                inputs: ::std::vec![
                    ::ethers::core::abi::ethabi::Param {
                        name: ::std::borrow::ToOwned::to_owned("initialSupplyRecipient"),
    ...
    impl ::ethers::core::abi::AbiDecode for ERC20Calls {
        fn decode(
            ...
            if let Ok(decoded)
                = <SetMinterCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::convert::From<MinterCall> for ERC20Calls {
